# Erweitert euren Synthesizer um (aus den vorherigen Aufgaben 7, 9, 10) einen Reverb Hall (Convoler), Distortion (Waveshaper), und einen Filter (BiquadFilter) mit den entsprechenden UI.
